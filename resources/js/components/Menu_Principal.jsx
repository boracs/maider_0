        ...
        <nav className="bg-gray-900 shadow-2xl">
            ...
            <div className=" w-full bcontainer mx-auto  px-4 py-3 flex items-center justify-between">
                ...
                <Link
                    ...
                    className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 hover:from-yellow-500 hover:to-pink-500 transition duration-500"
                >
                    + Que Surf
                </Link>
                ...
                <div className="hidden lg:flex items-center space-x-8">
                    <Link
                        href={route("Pag_principal")}
                        className="text-white hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 transition duration-500"
                    >
                        Inicio
                    </Link>
                    <Link
                    ...
                    <ToggleMenu menuItems={menuItemsTienda}>
                        <div className="flex items-center space-x-1 cursor-pointer group">
                            <span className="text-white hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 transition duration-500">
                                Tienda
                            </span>
                        ...
                        <>
                            ...
                            {user.role === "admin" && (
                                <>
                                    ...
                                    <Link
                                        href={route("asignar.taquilla.mostrar")}
                                        className="text-white hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 transition duration-500"
                                    >
                                        Taquilla
                                    </Link>
                            ...
                            {user.role !== "admin" &&
                                user.numeroTaquilla > 0 && (
                                    <>
                                        ...
                                        transition duration-300 ease-in-out pb-1 border-b-2 border-transparent hover:border-indigo-400"
                                        >
                                            Pedidos
                                        </Link>
                                        <Link
                                        ...
                                        <Link
                                            href={route("carrito")}
                                            className="flex items-center text-white hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 transition duration-500"
                                        >
                                            <FontAwesomeIcon
                                                icon={faShoppingCart}
                                                className="mr-2"
                        ...
                        <Dropdown>
                            <Dropdown.Trigger>
                                <span className="inline-flex rounded-md">
                                    <span className="mx-5 text-lg font-extrabold text-white">
                                        ! Hola{" "}
                ...
                >
                    <FontAwesomeIcon
                        icon={faBars}
                        className="w-6 h-6 text-white hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 transition duration-500"
                    />
                </button>
            </div>
            ...
            >
                <div className="px-4 py-3 space-y-4">
                    <Link
                        href={route("Pag_principal")}
                        className="block text-white hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 transition duration-500"
                    >
                        Inicio
                    </Link>
                    <Link
